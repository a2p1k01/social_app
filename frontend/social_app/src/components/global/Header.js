            ...
            <div className="max max-w-6xl w-full flex justify-between">
                ...
                >
                    <span className="text-4xl">
                        <iconify-icon icon="game-icons:axolotl">Social app logo</iconify-icon>
                    </span>
                    <h1 className="font-bold italic inline-block capitalize">
                        {isError ? "social_app" : cur}
                    </h1>
                </div>
                <div className="flex justify-between items-center gap-2 lg:gap-3">
                    ...
                    <p className="text-blue-400 text-lg xm:static fixed -top-36 capitalize">
                        {user && username}
                    </p>
                </div>
            </div>
