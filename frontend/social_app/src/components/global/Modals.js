    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="overflow-y-scroll h-full pb-12">
                    ...
                    {next && (
                        <div className="flex flex-col items-center w-full">
                            <button
                                className="text-blue-500 m-10 text-2xl p-1 flex justify-center items-center gap-1"
                ...
                <button className="bg-blue-400 text-purple-100" onClick={close}>
                    Close
                </button>
            </div>
        </Dialog>
...
const EditPostModal = ({ id, open, onClose }) => {
    ...
    return (
        ...
        >
            <div className="max-w-md mb-3 mx-auto w-screen dark:bg-black flex overflow-y-scroll flex-col p-2 gap-2 overflow-hidden">
                <div className="w-full grid-cols-[49px,_auto] h-min-content grid p-3  border-b-4 gap-1 bg-gray-100 mt-2 dark:bg-black dark:bg-opacity-90 dark:shadow-xl dark:border-gray-800">
                    ...
                    >
                        ...
                        <div>
                            <button
                                className="m-2 text-blue-500 text-2xl"
                                onClick={chooseImageFile}
                            >
                                <iconify-icon icon="bi:image">Choose Image</iconify-icon>
                            </button>
                            <button
                                className="bg-blue-400 text-purple-50 float-right px-2 h-8 rounded-full w-20"
                                type="submit"
                            >
                                Update
                            </button>
            ...
            <button
                className="bg-blue-400 text-purple-100 w-[96%] mx-auto rounded-sm mb-4 mt-auto"
                onClick={onClose}
            >
                Close
            </button>
