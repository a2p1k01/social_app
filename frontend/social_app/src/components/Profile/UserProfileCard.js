    ...
    return (
        <div className="mt-2 pl-3 p-2 bg-gray-50 w-full flex gap-2 items-center rounded-lg dark:bg-[#030108]">
            ...
            <Link
                ...
                className="float-right m-4 border-2 hover:bg-blue-500 hover:border-purple-100 hover:text-purple-100 p-1 px-2 rounded-full text-blue-500 text-[.7rem] border-blue-500"
            >
                View Profile
            </Link>
        </div>
